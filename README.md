...
<img src="./images/Screenshot 2025-07-10 170306.png" alt="Демонстрация" width="800">
 # Redis MurKir Security v2.0 - Полное описание системы

Исправления
Найдены ошибки в работе r-dns с IPv6, оптимизировал работу, error.log силишком много мусора записывается и нужно убрать создание сессии - проблемы с phpmyadmin.
