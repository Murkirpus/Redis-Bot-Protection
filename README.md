...
Добавленно JS Challenge - это автоматическая система проверки браузера, которая определяет ботов без участия пользователя. В отличие от традиционных CAPTCHA, где нужно выбирать картинки или вводить текст, JS Challenge работает полностью автоматически: браузер сам доказывает, что он настоящий.
...
<img src="./images/2025-12-04.png" alt="Демонстрация" width="500">
...
Добавленна работа с API - теперь можно блокировать IP в iptables - для работы API должен в php.ini не заблокирован exec !
Пока не все IP сами удаляются автоматически из Iptables через API - их нужно периодически очищать через API кнопкой - Очистить все!
Буду разбираться.
