 ...
 * 
 * jsChallengeSettings:
 *   trigger_on_no_cookie: true → false (НЕ показывать всем!)
...
class RedisBotProtectionNoSessions {
    ...
    private $apiSettings = [
        ...
        'url' => 'https://misite.com/redis-bot_protection/API/iptables.php',           // URL вашего API
    ...
    private $jsChallengeSettings = [
        ...
        // ═══════════════════════════════════════════════════════════════════
        'trigger_on_no_cookie' => false,            // v2.5.11: Было true, ОТКЛЮЧЕНО!
        'no_cookie_threshold' => 1,                 // УСТАРЕЛО: не используется при false
