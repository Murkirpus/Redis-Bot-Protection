...
class RedisBotProtectionNoSessions {
    ...
    private $allowedSearchEngines = [
        ...
        'yandexbot' => [
            ...
            'ip_ranges' => [
                // IPv4 ranges
                '5.45.192.0/18',       // Yandex crawlers
                '5.255.253.0/24',      // Yandex services
                '5.255.255.0/24',      // Yandex bot
                '37.9.64.0/18',        // Yandex network
                '37.140.128.0/18',     // Yandex services
                '77.88.0.0/18',        // Main Yandex range
                '84.201.128.0/18',     // Yandex cloud
                '87.250.224.0/19',     // Yandex services
                '93.158.128.0/18',     // Yandex crawlers
                '95.108.128.0/17',     // Yandex network
                '100.43.64.0/19',      // Yandex services
                '141.8.128.0/18',      // Yandex crawlers
                '178.154.128.0/17',    // Yandex services
                '185.32.185.0/24',     // Yandex bot
                '213.180.193.0/24',    // Yandex services
                // IPv6 ranges
                '2a02:6b8::/32',       // Yandex IPv6
...
<body>
    ...
    private function isLegitimateBot($userAgent) {
        $legitimateBots = [
            ...
            'oai-searchbot', 'chatgpt-user', 'claude-user', 'claudeBot', 'telegram', 'hosttracker', 'perplexity-user'
        ];
