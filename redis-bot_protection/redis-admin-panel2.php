...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Bot Protection Admin Panel</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
...
<body>
    <div class="header">
        <div class="header-content">
            <h1>🛡️ Bot Protection Admin Panel</h1>
            <div class="user-info">
    ...
    <div class="container">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="font-size: 11px; max-width: 150px; overflow: hidden;">
                                        <?php 
                                        if ($type === 'blocked' && isset($data['hostname']) && $data['hostname'] !== 'N/A') {
                                            echo '<span class="copyable" onclick="copyToClipboard(\'' . addslashes($data['hostname']) . '\', this)">' . htmlspecialchars($data['hostname']) . '</span>';
                                        } else {
                                            echo '—';
                                        }
                                        ?>
        ...
        <div style="text-align: center; padding: 20px; color: #888; font-size: 14px;">
            Bot Protection Admin Panel v1.0 | Работает на Redis
        </div>
    </div>
