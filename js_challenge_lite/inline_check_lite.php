 ...
 * ============================================================================
 * 
 * ВЕРСІЯ 3.8.5 - JS CHALLENGE LIFETIME FIX (2026-01-30)
 * 
 * НОВЕ v3.8.5:
 * 🔥 Cookie JS Challenge тепер дійсна 1.5 доби (36 годин) замість скидання опівночі
 * 🔥 Перевірка токена за останні 3 дні (сьогодні + вчора + позавчора)
 * 🔥 Повний User Agent в логах без обрізки
 * 🔥 Додано Baidu IP діапазон 116.179.0.0/16
 * 
 * ПРОБЛЕМА ЯКУ ВИРІШЕНО:
 * - Раніше токен був прив'язаний до date('Y-m-d') і скидався опівночі
 * - Тепер перевіряються токени за 3 останні дні
 * - Cookie lifetime збільшено до 129600 секунд (36 годин)
 * 
 * ============================================================================
 * 
 ...
 * 
 * НОВЕ v3.8.3:
 * 🔥 Оновлено IP діапазони Google з офіційного джерела
 * 🔥 Замінено широкі діапазони на точні /27 та /28 підмережі
 * 🔥 Додано 160+ IPv4 та 130+ IPv6 діапазонів Googlebot
 * 🔥 Джерело: https://developers.google.com/search/apis/ipranges/googlebot.json
 * 🔥 Дата оновлення Google: 2026-01-20
 * 
 * ВАЖЛИВО: Старі широкі діапазони (/16, /17) включали багато IP що НЕ є Googlebot!
 * Нові точні діапазони гарантують що тільки справжній Googlebot буде в whitelist.
 * 
 ...
 * 
 * Джерела:
 * - Google: https://developers.google.com/search/apis/ipranges/googlebot.json (ОНОВЛЕНО!)
...
$SEARCH_ENGINE_IP_RANGES = array(
    ...
    // ========================================================================
    // GOOGLEBOT - ОФІЦІЙНИЙ СПИСОК (2026-01-20)
    // Джерело: https://developers.google.com/search/apis/ipranges/googlebot.json
    // ========================================================================
...
function _jsc_isVerified($secret_key, $cookie_name) {
    ...
    // Це дозволяє cookie працювати ~36-72 години замість скидання опівночі
    $daysToCheck = array(
        date('Y-m-d'),                          // Сьогодні
        date('Y-m-d', strtotime('-1 day')),     // Вчора
        date('Y-m-d', strtotime('-2 days')),    // Позавчора
    );
